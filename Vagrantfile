...
$script = <<SCRIPT
    ...
    # Install PHP
    apt-get install -qq -y php5 php5-cli php5-common php5-gd php5-mysql php5-curl php5-intl php5-mcrypt php5-tidy php5-readline php-xdebug php-apc php5-memcached php5-memcache php5-imap php5-sqlite php5-xsl php-pear
